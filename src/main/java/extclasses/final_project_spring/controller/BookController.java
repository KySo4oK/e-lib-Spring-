...
public class BookController {
    ...
    public BookController(BookService bookService, CustomSuccessResponseEntity responseEntity) {
    ...
    public ResponseEntity<Map<String, String>> addBook(@RequestBody BookDTO bookDTO) {
        ...
        return responseEntity.getEntityWithMessage("book.added");
    }
    ...
    public ResponseEntity<Map<String, String>> editBook(@RequestBody BookDTO bookDTO) {
        ...
        return responseEntity.getEntityWithMessage("book.edited");
    }
    ...
    public ResponseEntity<Map<String, String>> deleteBook(@PathVariable("id") long id) {
        ...
        return responseEntity.getEntityWithMessage("book.deleted");
    }
}
